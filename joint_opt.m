...
fplot(profit_p,p_fit_interval,'LineWidth',1.5,'Marker','^','MarkerSize',6)
xlabel({'Price'},'FontSize',12)
ylabel(['Profit'],'FontSize',12)
legend(["Simulated profit curve","Estimated profit curve"],'location','south','FontSize',10,'NumColumns',1)
%% plot profit and approximated profit for simulated pars
fprofit_compare=figure;
fsurf(profit_simu_fd,[p_simu_interval,T_interval])
hold on
fsurf(profit_appro_simu_fd,[p_simu_interval,T_interval])
% view(gca,[-150 30]);
...
ylabel(['Ordering cycle'],'FontSize',12)
zlabel(['Profit'],'FontSize',12)
legend(["Profit surface","Approximated profit surface"],'location','northeast','FontSize',10,'NumColumns',1)
%% save figure
...
savefig(fprofit_compare,'.\figure\profit_compare.fig')
exportgraphics(fprofit_compare,'.\figure\profit_compare.pdf')
